...
/**
 * 1、后端向前段输出的有两种方式OutputStream和PrintWriter
 * 2、设置字符的方法
 * 3、OutputStream返回格式是字节数组
 * 4、PrintWriter返回格式是字符串 
 * 
 * @author: gzb
 * @date  : 2019年8月13日 下午6:56:58
 *
 */
public class ResponseDemo01 extends HttpServlet {
    ...
    public void outputChineseByPrintWriter(HttpServletResponse response) throws IOException{
         ...
         */
        PrintWriter printWriter = response.getWriter();//获取PrintWriter输出流
        /**
        ...
        printWriter.write(data);//使用PrintWriter流向客户端输出字符
    }
