...
public class ResponseDemo03 extends HttpServlet{
     ...
     * 
     * @author: gzb
     * @date  : 2019年8月14日 上午10:51:20
     * @param response
     * @throws IOException 
     */
    private void getImage2(HttpServletRequest request,HttpServletResponse response) throws IOException {
        response.setHeader("refresh", "5");//设置refresh响应头控制浏览器每隔5秒钟刷新一次
        // 在内存中创建一张图片
